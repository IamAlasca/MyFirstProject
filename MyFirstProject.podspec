#
#  Be sure to run `pod spec lint MyFirstProject.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Aaron Zhou"
  # s.authors            = { "Aaron Zhou" => "" }
  # s.social_media_url   = "http://twitter.com/Aaron Zhou"
